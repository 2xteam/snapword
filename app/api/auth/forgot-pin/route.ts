 ...
 * → myjane/app/api/auth/forgot-pin · my-obsidian-vault / 50-Plans/C 법적 페이지.md
 */
  ...
  return NextResponse.json(
    {
      ok: false,
      error:
        "계정 찾기는 myjane 에서 진행합니다. https://www.myjane.co.kr/forgot-pin 을 이용해 주세요.",
    },
    { status: 410 },
  );
}
